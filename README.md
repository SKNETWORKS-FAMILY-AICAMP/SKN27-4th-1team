...
9. [인증 및 보안](#9-인증-및-보안)
10. [테스트 및 평가](#10-테스트-및-평가)
11. [시연 화면](#11-시연-화면)
12. [기대 효과 및 결론](#12-기대-효과-및-결론)
13. [팀원 회고](#13-팀원-회고)
...
관계형 조회가 유리한 지역, 장소, 괴담, 괴이 간의 상호 관계를 구조적으로 탐색하기 위해 Neo4j를 분리 구성했습니다. 

### 활용 목적
단순 텍스트 검색을 넘어 특정 지역에 얽힌 장소들을 찾고, 해당 장소와 연결된 괴담을 시각적/구조적으로 조회할 수 있는 "지역 정보실" 기능에 활용됩니다.

### 대표적 노드/관계 구조
- `(Region)-[:HAS_PLACE]->(Place)`
- `(Place)-[:HAS_STORY]->(Story)`
