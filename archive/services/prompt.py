...
- 마지막 문단은 설명이나 교훈이 아니라 새 모순으로 끝낸다.
...
- 공포의 정체를 귀신, 악령, 괴물이라고 단정하지 마라.
- 꿈, 환각, 죽은 사람 반전으로 해결하지 마라.
- "무서웠다", "소름이 돋았다", "공포에 질렸다"처럼 감정을 직접 설명하지 마라.
...
10점:
일상적인 디테일에서 시작해 마지막 모순까지 자연스럽게 이어진다.
...
0점:
문학 작품, 라디오 사연, 책 낭독문처럼 보인다.

5점:
체험담 같기는 하지만 문장이 너무 정돈되어 있다.

10점:
익명 게시판에 올라온 실제 글처럼 보인다.
...
80~89점:
괜찮지만 일부 문장이 아직 정돈되어 있음

70~79점:
공포 구조는 있으나 게시글 느낌이 약함
...
소설체:
"그날 밤, 방 안은 완전히 어둠에 뒤덮여 있었다."

게시글체:
"그날은 불 끄고 바로 누웠던 걸로 기억함."
...
소설체:
"아직도 그 밤은 내 가슴속에 남아 있다."

게시글체:
"근데 다음날 엄마가 한 말이 아직도 좀 걸림."
